# Библиотека навыков для разработчиков

Полная коллекция навыков для AI агентов, специализированных на различных аспектах разработки программного обеспечения.
...
### 2. **Архитектор программного обеспечения** (`architect/SKILL.md`)
...
### 3. **Разработчик PHP** (`php-developer/SKILL.md`)
...
### 4. **Разработчик C++** (`cpp-developer/SKILL.md`)
...
### 5. **Web разработчик** (`web-developer/SKILL.md`)
...
### 6. **Frontend дизайнер (Skeleton CSS)** (`frontend-designer/SKILL.md`)
...
### 7. **Разработчик баз данных** (`database-developer/SKILL.md`)
...
### 8. **Специалист по тестовым сценариям** (`test-scenario-writer/SKILL.md`)
...
### 9. **Специалист по написанию тестов** (`test-writer/SKILL.md`)
...
### 10. **MariaDB Administrator** (`mariadb-administrator/SKILL.md`) ⭐ на базе Database Developer
...
### 11. **Moodle Developer** (`moodle-developer/SKILL.md`) ⭐⭐ на базе PHP Developer + MariaDB Administrator
...
### 12. **DevOps инженер** (`devops-engineer/SKILL.md`) ⭐ на базе Web Developer
...
### 13. **Специалист по технической документации** (`technical-documentation-specialist/SKILL.md`)
...
### 14. **Специалист по искусственному интеллекту** (`ai-specialist/SKILL.md`)
...
### 15. **AI Product Manager** (`ai-product-manager/SKILL.md`) ⭐ производный от Специалиста по искусственному интеллекту
...
### 16. **AI Prompt Engineer** (`ai-prompt-engineer/SKILL.md`) ⭐ производный от Специалиста по искусственному интеллекту
